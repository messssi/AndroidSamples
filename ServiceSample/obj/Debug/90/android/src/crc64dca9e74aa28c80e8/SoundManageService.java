...
public class SoundManageService
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ServiceSample.SoundManageService, ServiceSample", SoundManageService.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == SoundManageService.class)
			mono.android.TypeManager.Activate ("ServiceSample.SoundManageService, ServiceSample", "", this, new java.lang.Object[] {  });
	}
